...
public class MainFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtRussian.setToolTipText("Ctrl + R");
        txtRussian.setFocusAccelerator('r');
        ...
        edtPaneGrammarPart1.setFont(new java.awt.Font("Ubuntu", 0, 18)); // NOI18N
        ...
        jEditorPane5.setText("<html>\n  <head>\n\n  </head>\n  <body>\n    <p style=\"margin-top: 0\">\n      <p>Союз <span style=\"font-size: 24\">...أَمَّا... فَ</span> означает \"что касается..., то...\". Как правило, подлежащее, следующее за <span style=\"font-size: 24\">أَمَّا</span> в первой части предложения, повторяется во второй ее части в виде соответствующего личного местоимения. Последнее пришется с <span style=\"font-size: 24\">فَ</span> слитно. При этом союз <span style=\"font-size: 24\">...أَمَّا... فَ</span> не влечет за собой изменений падежных флексий.</p>\n      <p>Если предлог <span style=\"font-size: 24\">لِ</span> присоединятеся к определенному артиклю, то <span style=\"font-size: 24\">آَ</span> опускается - <span style=\"font-size: 24\">للْمعلم</span>. Если в слове с определенным артиклем первой коренной является <span style=\"font-size: 24\">ل</span>, то опускается весь артикль - <span style=\"font-size: 24\">للّغة</span>.</p>\n      <p>Указательное местоимение, выступающее в качестве определения, ставится перед именем существительным с артиклем и согласуется с ним в роде, числе и падеже. Если имя без артикля, то указательное местоимение ставится после имени со всеми его определениями.</p>\n      <p>Оборот <span style=\"font-size: 24\">عِيَارَةٌ عَنْ</span> означает \"представляет собой\".</p>\n      <p>В начале произносимой речи соединительная хамза читается: с фатхой в определенном артикле; с даммой в глаголе, третья буква которой также с даммой; в остальных случаях с кясрой.</p>\n    </p>\n  </body>\n</html>\n");
